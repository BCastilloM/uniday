...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Materia> materias2026 = List.of(
            crearMateria(semestre2026_1.getId(), "Programación Orientada a Objetos", "INF-220", 5, "Paradigma de orientación a objetos, herencia, polimorfismo y patrones de diseño en Java.", "Ing. Carlos Muñoz", 80),
            crearMateria(semestre2026_1.getId(), "Base de Datos", "INF-230", 5, "Diseño relacional, normalización, SQL avanzado y fundamentos de transacciones ACID.", "Ing. Ana Reyes", 75),
            crearMateria(semestre2026_1.getId(), "Ingeniería de Software I", "INF-240", 4, "Ciclos de vida del software, metodologías ágiles Scrum y modelado UML.", "Ing. Pedro Soto", 70),
            crearMateria(semestre2026_1.getId(), "Redes de Computadores", "TEL-210", 4, "Modelo OSI, TCP/IP, direccionamiento IPv4/IPv6, protocolos de capa de transporte y enlace.", "Ing. Luis Fuentes", 85),
            crearMateria(semestre2026_1.getId(), "Estadística y Probabilidades", "MAT-215", 4, "Variables aleatorias, distribuciones de probabilidad, intervalos de confianza y pruebas de hipótesis.", "Prof. Claudia Vera", 75)
        );
        ...
        List<Materia> materias2025 = List.of(
            crearMateria(semestre2025_2.getId(), "Estructuras de Datos", "INF-120", 5, "Listas enlazadas, árboles binarios, grafos y algoritmos de ordenamiento y búsqueda.", "Ing. Carlos Muñoz", 80),
            crearMateria(semestre2025_2.getId(), "Sistemas Operativos", "INF-130", 5, "Gestión de procesos, memoria virtual, concurrencia, sincronización y sistemas de archivos.", "Ing. Roberto Díaz", 75),
            crearMateria(semestre2025_2.getId(), "Inglés Técnico", "IDI-101", 3, "Lectura comprensiva de documentación técnica y redacción de especificaciones en inglés.", "Prof. Sarah Mitchell", 70)
        );

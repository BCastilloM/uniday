...
CREATE TABLE IF NOT EXISTS materias (
    ...
    icono              VARCHAR(30)  NOT NULL DEFAULT 'bi-book',
    PRIMARY KEY (id),
...
INSERT INTO usuarios (id, nombre, email, password, fecha_creacion) VALUES
    (1, 'Alejandro Troncoso', 'demo@uniday.cl',
...
INSERT INTO materias (id, semestre_id, nombre, profesor, codigo, creditos, descripcion, asistencia_exigida, color, icono) VALUES
    (1, 1, 'Programación Orientada a Objetos',   'Ing. Carlos Muñoz', 'INF-220', 5, 'Paradigma de orientación a objetos, herencia, polimorfismo y patrones de diseño en Java.', 80, '#3B82F6', 'bi-cpu'),
    (2, 1, 'Base de Datos',                      'Ing. Ana Reyes',    'INF-230', 5, 'Diseño relacional, normalización, SQL avanzado y fundamentos de transacciones ACID.', 75, '#22C55E', 'bi-database'),
    (3, 1, 'Ingeniería de Software I',           'Ing. Pedro Soto',   'INF-240', 4, 'Ciclos de vida del software, metodologías ágiles Scrum y modelado UML.', 70, '#A855F7', 'bi-lightbulb'),
    (4, 1, 'Redes de Computadores',              'Ing. Luis Fuentes', 'TEL-210', 4, 'Modelo OSI, TCP/IP, direccionamiento IPv4/IPv6, protocolos de capa de transporte y enlace.', 85, '#F97316', 'bi-globe'),
    (5, 1, 'Estadística y Probabilidades',       'Prof. Claudia Vera', 'MAT-215', 4, 'Variables aleatorias, distribuciones de probabilidad, intervalos de confianza y pruebas de hipótesis.', 75, '#06B6D4', 'bi-calculator'),
    (6, 2, 'Estructuras de Datos',               'Ing. Carlos Muñoz', 'INF-120', 5, 'Listas enlazadas, árboles binarios, grafos y algoritmos de ordenamiento y búsqueda.', 80, '#EF4444', 'bi-book'),
    (7, 2, 'Sistemas Operativos',                'Ing. Roberto Díaz', 'INF-130', 5, 'Gestión de procesos, memoria virtual, concurrencia, sincronización y sistemas de archivos.', 75, '#F59E0B', 'bi-gear'),
    (8, 2, 'Inglés Técnico',                     'Prof. Sarah Mitchell', 'IDI-101', 3, 'Lectura comprensiva de documentación técnica y redacción de especificaciones en inglés.', 70, '#EC4899', 'bi-translate');
